...
const ContentFeature = ({ image, title, description, contentsAvailable }) => (
  <div className="w-1/3 p-4">
    <div className="flex flex-col items-center">
      ...
      <button className="bg-shape_red text-white py-2 px-10 rounded-full mb-4 text-sm">VER CONTENIDOS</button>
